...
img.as_ocr_box_reader().save_img(rgb=[255,0,0], path = ["img_01_half","origin"])
img.row_half(1)
img.as_ocr_box_reader().show_img(rgb=[255,0,0], title="half")
img.as_ocr_box_reader().save_img(rgb=[255,0,0], path=["img_01_half","half"])
img.as_ocr_box_reader().save_many_imgs(rgb=[255,0,0], path=["img_01_half", "subhalf"])
